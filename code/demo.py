...
def train_sparse_hm(data, components, gamma, distance_cutoff, map_resolution=None):
	...
	for data, label in util.data_generator(poses, scans):
		...
		sys.stdout.flush()
		print('\n...current %%: ', percent_map)
		if percent_map > old_percent_map + 1:
...
def main():
	...
	parser.add_argument("--log_dir", help="Logfile in CARMEN format to process",\
		default="/media/sf_cogntivive_school/hilbert_map/datasets/intel.gfs.log")
